...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    ...
    /** Instead of (body2 & caption) */
    labelSmall: _lightScreenButtonTextStyle,
    /** Instead of (button) */
    displayLarge: _lightScreenTaskNameTextStyle,
    /** Instead of (title) */
    titleMedium: _lightScreenTaskNameTextStyle, /** Instead of (subhead) */
    // caption: _lightScreenCaptionTextStyle, /** Instead of (caption) */
  );
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    ...
    displayLarge: _darkScreenTaskNameTextStyle,
